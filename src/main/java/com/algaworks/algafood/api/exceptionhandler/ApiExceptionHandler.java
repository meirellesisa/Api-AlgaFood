...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex,
		...
		ProblemType problemType = ProblemType.PARMETRO_INVALIDO;
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		if(rootCause instanceof InvalidFormatException) {
		 ...
		 String detail = "O corpo da requisição está inválido. Verifique erro de sitaxe.";
	...
	private ResponseEntity<Object> handleInvalidFormatException(InvalidFormatException ex,
			HttpHeaders handers, HttpStatus status, WebRequest request) {
		...
		return handleExceptionInternal(ex, problem, handers, status, request);
	}
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		ProblemType problemType = ProblemType.RECURSO_NAO_ENCONTRADA;
		String detail = String.format("O recurso '%s', que você tentou "
				+ "acessar, é inexistente", ex.getRequestURL());
